...
import AdminLicensingEditScreen from '../../screens/admin/licensing/AdminLicensingEditScreen';
...
const AdminLicensingStackNavigator = () => (
  <Stack.Navigator screenOptions={{ headerShown: false }}>
    ...
    <Stack.Screen name="AdminLicensingEdit" component={AdminLicensingEditScreen} />
