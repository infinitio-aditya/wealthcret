...
const MemberRolesScreen = () => {
    ...
    const presetColors = [
        '#ef4444', '#3b82f6', '#8b5cf6', '#f59e0b', '#10b981', '#06b6d4', '#ec4899', '#6366f1'
    ];
                ...
                <View style={styles.statsRow}>
                    ...
                    <Card style={styles.statCard}>
                        <View style={[styles.statIconContainer, { backgroundColor: theme.colors.secondary + '20' }]}>
                            <Icon name="people-outline" size={20} color={theme.colors.secondary} />
                        </View>
                        <Text style={styles.statValue}>{roles.reduce((sum, role) => sum + role.membersCount, 0)}</Text>
                            ...
                            <View style={styles.roleHeader}>
                                <View style={styles.roleInfo}>
                                    ...
                                    <View>
                                        ...
                                        <Text style={styles.memberCount}>{role.membersCount} members</Text>
                                    </View>
                                </View>
                    ...
                    <ScrollView style={styles.form} showsVerticalScrollIndicator={false}>
                        ...
                        <View style={styles.formGroup}>
                            ...
                            <Input
                                ...
                                multiline
                                numberOfLines={3}
                                style={[styles.readOnlyInput, { height: 80, textAlignVertical: 'top', color: theme.colors.text }]}
                            />
                        </View>
