...
const InviteScreen = () => {
    ...
    const handleOrgInvite = () => {
        ...
        if (!email || !firstName || !lastName || !name || (type === 'client' && !referrerOrg)) {
        ...
        setTimeout(() => {
            setLoading(false);
            Alert.alert('Success', 'Organization invitation sent successfully!');
            setOrgForm({
                type: 'service_provider',
                name: '',
                referrerOrg: '',
    ...
    return (
        <View style={styles.container}>
            <View style={styles.header}>
                ...
                <Text style={styles.subtitle}>Send invitations to new organizations and users</Text>
            </View>
                ...
                {activeTab === 'organization' ? (
                    <Card>
                        ...
                        {orgForm.type === 'client' && (
                            <Input
                                ...
                                onChangeText={(val) => setOrgForm({ ...orgForm, referrerOrg: val })}
                        ...
                        <View style={styles.row}>
                            <View style={styles.flex1}>
                                <Input
                                    ...
                                    onChangeText={(val) => setOrgForm({ ...orgForm, firstName: val })}
                            ...
                            <View style={styles.flex1}>
                                <Input
                                    ...
                                    onChangeText={(val) => setOrgForm({ ...orgForm, lastName: val })}
                    ...
                    <Card>
                        <ThemeDropdown
                            ...
                            onValueChange={(val) => setUserForm({ ...userForm, orgType: val })}
                        />

                        <Input
                            label="Organization *"
                            value={userForm.organization}
                            onChangeText={(val) => setUserForm({ ...userForm, organization: val })}
                        ...
                        <View style={styles.switchContainer}>
                            ...
                            <Switch
                                ...
                                onValueChange={(val) => setUserForm({ ...userForm, isAdmin: val })}
                                trackColor={{ false: theme.colors.textSecondary + '40', true: theme.colors.primary }}
                        ...
                        <View style={styles.row}>
                            <View style={styles.flex1}>
                                <Input
                                    ...
                                    onChangeText={(val) => setUserForm({ ...userForm, firstName: val })}
                                    placeholder="First Name"
                                />
                            </View>
                            <View style={styles.flex1}>
                                <Input
                                    ...
                                    onChangeText={(val) => setUserForm({ ...userForm, lastName: val })}
                                    placeholder="Last Name"
                                />
                            </View>
                        </View>
