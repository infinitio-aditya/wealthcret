...
const OrganizationRequestsScreen = () => {
            ...
            <Card style={styles.requestCard}>
                <View style={styles.requestHeader}>
                    ...
                    <View style={styles.badges}>
                        ...
                        <View style={[styles.badge, { backgroundColor: getTypeColor(item.requestType) + '20' }]}>
                            <Text style={[styles.badgeText, { color: getTypeColor(item.requestType) }]}>
    ...
    const stats = [
        ...
        { label: 'Approved', count: approvedCount, icon: 'checkmark-circle-outline', color: theme.colors.success },
        { label: 'Rejected', count: rejectedCount, icon: 'close-circle-outline', color: theme.colors.error },
    ];
