        ...
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView style={styles.content}>
                ...
                <View style={styles.section}>
                    ...
                    <Text style={styles.paragraph}>
                        This information may include: name, email, phone number, postal address, profile picture, payment method, financial information, and other information you choose to provide.
                    </Text>
                </View>
                ...
                <View style={styles.section}>
                    ...
                    <Text style={styles.paragraph}>
                        We may share the information we collect about you as described in this statement or as described at the time of collection or sharing, including sharing with vendors, consultants, and other service providers.
                    </Text>
                </View>
                ...
                <View style={styles.section}>
                    ...
                    <Text style={styles.paragraph}>
                        If you have any questions about this Privacy Policy, please contact us at privacy@wealthcret.com.
                    </Text>
                </View>
